    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _buildInfoTile(
                Icons.info_outline, 'Description', event.description),
      ...
      child: Column(
        ...
        children: [
          const Text('Financial Overview',
              style: TextStyle(
                  color: AppTheme.warningOrange, fontWeight: FontWeight.bold)),
          const SizedBox(height: 12),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text('Allocated Budget'),
              Text('₹${event.budgetAllocated}',
                  style: const TextStyle(
  ...
  Widget _buildDocumentsList() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Sponsorship & Documents',
              style: TextStyle(
                  color: AppTheme.accentNeon, fontWeight: FontWeight.bold)),
          const SizedBox(height: 8),
          if (event.documentUrls.isEmpty && event.sponsorInfo.isEmpty)
            const Text('No assets uploaded yet.',
                style: TextStyle(color: AppTheme.textSecondary)),
        ],
      ),
    );
