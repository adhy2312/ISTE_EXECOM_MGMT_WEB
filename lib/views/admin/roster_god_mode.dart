...
class RosterGodModeScreen extends ConsumerWidget {
  const RosterGodModeScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Roster God View',
              ...
              return Card(
                ...
                child: ListTile(
                  leading: CircleAvatar(
                    ...
                    child: Text(m.fullName.substring(0, 1),
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                              content:
                                  Text('Injected 50 points to ${m.fullName}')));
                        },
  ...
  void _showDeleteConfirm(BuildContext context, WidgetRef ref, ExecomMember m) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: const Text('Annihilate Member?',
            style: TextStyle(color: Colors.redAccent)),
        content: Text(
            'Are you sure you want to permanently delete ${m.fullName} from the database? This cannot be undone.'),
        backgroundColor: AppTheme.surfaceDark,
        actions: [
          TextButton(
